            ...
            <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                <div className="relative flex h-16 items-center justify-between">
                    ...
                    <div className="flex flex-1 items-center  justify-center sm:items-stretch sm:justify-start">
                        <Link to="/Home" className='-ml-4'><div className="flex xxs:mr-12  flex-shrink-0 items-center">
                            <img
                                alt="HealthInsightAI"
                                src={Logo}
                    ...
                    <div className="absolute inset-y-0 right-0 flex justify-around items-center xxs:space-x-4 max-sm:space-x-8 md:space-x-4 lg:space-x-8 xl:space-x-14 pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0 ">
                                    ...
                                    <>
                                        ...
                                        {stateNbrNot &&
                                            <div className='py-1 mt-2 px-2 m-auto w-full h-10  ' >
                                                <Link to="/Notifications">
                                                    <span className='flex text-md  justify-center py-1 font-semibold border-2 hover:bg-purple-200 text-purple-600 border-purple-500 rounded-lg '>View More ...</span>
                                                </Link>
                                            </div>
                                        }
                                        {if0Notif &&
