...
function ThemeToggle() {
    ...
    return (
        ...
        <div className='relative  w-12 h-6 flex items-center bg-gray-500 dark:bg-gray-800 rounded-full p-1 cursor-pointer'
        onClick={() => setDarkMode(!darkMode)}>
        <FaMoon className='text-white size={12} '/>
            <div className='absolute bg-slate-200 dark:bg-slate-200 w-5 h-5 rounded-full shadow-md transform transition-transform duration-400'
