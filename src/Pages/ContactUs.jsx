            ...
            <section className="w-4/6 max-sm:w-full max-sm:p-8 max-sm:my-0 m-auto my-10 p-4 shadow-lg  bg-slate-200 dark:bg-slate-800 rounded-xl">
                <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                    ...
                    <form action="#" className="space-y-8">
                        <div>
                            <label htmlFor="email" className="block mb-2 text-sm font-medium text-slate-500 dark:text-slate-400">Your email</label>
                            <input
                                type="email"
                                id="email"
                                defaultValue={auth?.currentUser?.email}
                                className="shadow-sm  border  text-Deep-Violet text-sm rounded-lg block w-full p-2.5 dt"
                                placeholder="enter your mail"
                                required
                            />
                        </div>
                        <div>
                            <label htmlFor="subject" className="block mb-2 text-sm font-medium  text-slate-500 dark:text-slate-400">Subject</label>
                            <input
                                type="text"
                                id="subject"
                        ...
                        <div className="sm:col-span-2">
                            <label htmlFor="message" className="block mb-2 text-sm font-medium  text-slate-500 dark:text-slate-400">Your message</label>
                            <textarea
                                id="message"
                                rows="6"
                                required
                        ...
                        <button
                            type="submit"
                            className="py-3 px-5 text-sm font-semibold text-center bg-purple-600 text-white hover:bg-purple-700 rounded-lg  sm:w-fit "
                        >
                            Send message
                        </button>
                    </form>
